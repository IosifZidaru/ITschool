...
public class StringExample {
    ...
    public static void stringPool(){
        ...
        System.out.println("str2 locatiom" + System.identityHashCode(str2));
   ...
   public static void stringOperetors(){
       ...
       System.out.println("comparam code1 vu code2 " +(code1 == code2));

       System.out.println(code1 + 123 + true + "final de string");
       System.out.println(123 +17 + "inceput " + code4 + 123) ;
   }

   public static  void stringmMethods(){
        String str1 = "Hello world";
        String str2 = " hello wworld";
       System.out.println("str1 == str2 :" + (str1 == str2));
       System.out.println(" str1 equels str2 : " + str1.equals(str2));
       System.out.println("str1 equels ignore str2 : " + str1.equalsIgnoreCase(str2));
       ...
       System.out.println("substring din stq1 : " + str1.substring(3));
       System.out.println("lowercase str1 : " + str1.toLowerCase());
       System.out.println("upeercase str1 : " + str1.toUpperCase());

       System.out.println("stars with H? : " + str1.startsWith("H"));
       System.out.println("start with Hell? : " + str1.startsWith("Hello"));
